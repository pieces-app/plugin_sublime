...
def plugin_loaded(): # Call the download github on the plugin load to avoid duplicated calls
	if check:
		...
		sublime.set_timeout_async(lambda:PiecesDependencies.download_github_repo('https://github.com/pieces-app/sublime-dependencies', "1.0.0" ,PiecesDependencies.lib_path), 0)
