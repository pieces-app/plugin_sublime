...
class ModelsEnum(Enum):
	...
	GEMINI_2_FLASH_EXP = ("gemini-2.0-flash-exp", "Gemini 2 Flash Experimental", "An advanced iteration in Google's Gemini series optimized for rapid response times and efficient processing. Includes architectural improvements from Gemini 1.5 while maintaining competitive language understanding.")
	GEMINI_2_FLASH_LITE = ("gemini-2.0-flash-lite-001", "Gemini 2 Flash Lite", "")
	GEMINI_2_5_PRO_EXP = ("gemini-2.5-pro-exp-03-25", "Gemini 2.5 Pro Experimental", "")
	GEMINI_2_5_FLASH_PREVIEW = ("gemini-2.5-flash-preview-04-17", "Gemini 2.5 Flash Preview", "")
	GEMINI_2_5_PRO_PREVIEW = ("gemini-2.5-pro-preview-03-25", "Gemini 2.5 Pro Preview", "")
	...
	GPT4_1 = ("gpt-4.1-2025-04-14", "GPT-4.1", "")
