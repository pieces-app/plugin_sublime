...
from Pieces._pieces_lib.websocket._exceptions import WebSocketProxyException, WebSocketException
from Pieces._pieces_lib.websocket._http import (
    _get_addrinfo_list,
...
try:
    ...
    from Pieces._pieces_lib.websocket._http import ProxyConnectionError, ProxyError, ProxyTimeoutError
